  ...
  return (
    <div id="shop-by-mausam" className="px-8 py-[100px] md:px-16 text-center">
      ...
      <div className="border-b border-border mb-14">
        <div className="no-scrollbar flex md:justify-center gap-0 overflow-x-auto flex-nowrap md:flex-wrap snap-x snap-proximity -mx-8 px-8 md:mx-0 md:px-0">
          {seasonTabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
              ...
              className={
                activeTab === tab.id
                  ? 'shrink-0 snap-start whitespace-nowrap px-5 py-3 md:px-8 md:py-4 font-serif text-sm md:text-xl border-b-2 border-ink transition-colors duration-300 cursor-pointer bg-transparent'
                  : 'shrink-0 snap-start whitespace-nowrap px-5 py-3 md:px-8 md:py-4 font-serif text-sm md:text-xl text-muted border-b-2 border-transparent transition-colors duration-300 hover:text-ink cursor-pointer bg-transparent'
              }
            >
              {tab.name}
            </button>
