      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-7 text-left">
          {bestsellers.map((item) => (
            <div key={item.name} className="product-card hover-lift bg-cream relative overflow-hidden flex flex-col justify-between">
              <div className="relative aspect-4/5 overflow-hidden bg-beige">
                ...
                />
                <div className="quick-add absolute bottom-0 left-0 right-0 bg-ink text-cream text-center p-3 text-[11px] tracking-[0.1em] uppercase cursor-pointer">
                  Quick Add
                </div>
              </div>
              <div className="p-4 sm:p-5 flex flex-col flex-1 justify-between">
                <div>
                  <div className="text-[10px] tracking-[0.1em] uppercase text-gold mb-1">{item.category}</div>
